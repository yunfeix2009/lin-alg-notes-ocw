...
To find $vb(V)$ and $vb(U)$ given any $vb(A)$, we convert $vb(A)$ to a symmetric form such that $vb(U)$ or $vb(V)$ becomes its eigenvector matrix. To find $vb(V)$, take $ vb(A^top A &= (U Sigma V^top)^top (U Sigma V^top)) \
                                                   & = vb(V Sigma U^top U Sigma V^top) \
...
To find $vb(U)$ take $ vb(A A^top) & = vb((U Sigma V^top) (U Sigma V^top)^top) \
            & = vb(U Sigma V^top V Sigma U^top) \
            & = vb(U) diag(sigma_i)^2 vb(U^top). $
