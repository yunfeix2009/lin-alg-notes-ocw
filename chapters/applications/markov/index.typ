...
#solution[
  ...
  The characteristic equation of $vb(A)$ is $ det(vb(A) - lambda vb(I)) . $ Since $lambda_1 = 1$ and $trace vb(A) = sum_(lambda "eigenvalue") lambda$, $lambda_2 = .7$. Notice the eigenvector $ vb(x)_1 = mat(-2; 1), quad vb(x)_2 = mat(-1; 1), $ $ vb(u) & = c_1 lambda_1^(k) vb(x)_1 + c_2 lambda_2^(k) vb(x)_2 \
        & = c_1 mat(-2; 1) + c_2 (.7)^k mat(-1; 1). $
